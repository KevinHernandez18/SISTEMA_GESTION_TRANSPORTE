...
SECRET_KEY = 'django-insecure-u76%%8o*7$bw1du6$v26(c_%r2g0*q-6hwf&qm_h9gqc&l#y3)'
...
MIDDLEWARE = [
    ...
    'gestion_transporte.mixins.ThreadLocalMiddleware',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'api_operations.log',
            'formatter': 'default',
        },
    },
    'loggers': {
